...
Venta* venta_newConParametros(char* codigoProducto,char* fecha,char* precioUnitario,char* idVenta,char* unidades, char* cuit);
...
int criterioMayorAMax(void* this, int maximo);
