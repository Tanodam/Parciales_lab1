...
int ll_sort(LinkedList* this, int (*pFunc)(void*,void*), int order)
{
    ...
    if(this != NULL && pFunc != NULL && (order == 1 || order == 0))
    {
        do
        {
            ll_startIter(this);//Seteo el iterador en el head del Linkedlist
            ...
            for(i=0;i<ll_len(this)-1;i++)
            {
                ...
                elementB = ll_getNext(this);//Se hace el get del siguiente elemento al auxiliar
...
/**
 * \brief Retorna el elemento del NodoGlobal (iterador) y mueve un lugar el nodoGlobal
...
/**
 * \brief Recibe el LinkedList y el puntero a una funcion criterio utilziada para crear un informe
 * \param this Es el LinkedList que recibe para recorrer
 * \param pFunc Es el puntero a la función que se encargara de validar el criterio de conteo
 * \return Retorna 0 si logra ejecutar la función con todos los elementos sino retorna -1
*/
...
/**
 * \brief Funcion que setea la variable nodoGlobal de la LL en NULL para liberar el nodo de la ultimia iteracion realizada
 * \param this Es el LinkedList es la LL donde se encuentra el nodo.
 * \return Retorna 0 si logra ejecutar la función con todos los elementos sino retorna -1
*/
